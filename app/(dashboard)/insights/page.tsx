        ...
        <>
          <div className="border-t-2 border-purple-200 pt-6">
            <h2 className="text-2xl font-bold mb-2 flex items-center gap-2">
              ...
              Insights de Salud del EDA
            </h2>
            <p className="text-gray-600 mb-6">
              Análisis personalizado basado en tus patrones biométricos
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            {scorecard?.duration_hours && (
              <SleepScorecardWidget
                ...
                hrv={scorecard.hrv}
                date={scorecard.calendar_date ? format(new Date(scorecard.calendar_date), "d 'de' MMMM", { locale: es }) : undefined}
              />
            )}
          </div>
